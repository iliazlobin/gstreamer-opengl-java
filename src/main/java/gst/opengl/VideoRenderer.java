...
//    private static final File File = new File("/mnt/OKTAUTODRV/video-samples/train/video1.m4v");
//    private static final File File = new File("/mnt/OKTAUTODRV/video-samples/timecode.m2v");
    private static final File File = new File("/mnt/OKTAUTODRV/video-samples/heavy.mkv");
    ...
    public VideoRenderer(JFXGLContext context) {
        ...
        try {
            ...
            shader = new TexturedQuad.Shader(
                ...
                VideoRenderer.class.getClassLoader().getResource("greenscreen.fragment.glsl")
            );
